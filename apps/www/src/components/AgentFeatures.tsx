...
const agentFeatures: Agent[] = [
  ...
  },
  {
    ...
    code: 'AGENT',
    description:
      'Built on the flue agent framework, CodeSentinel runs a real agent loop with developer tools — so it reads far beyond the diff to understand the full picture.',
    features: [
        ...
        <div className="flex flex-col items-center py-24 lg:py-32">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-5 max-w-xl text-balance text-muted-foreground">
              CodeSentinel does the read-through a human reviewer would — on every change you
              ship.
            </p>
          </div>
          ...
          >
            ...
            <ShellCommand command="npx CodeSentinel init" />
            <p className="text-center font-mono text-[11px] uppercase tracking-[0.15em] text-muted-foreground/70">
              Or run <span className="text-foreground/80">npx CodeSentinel review</span> on
              your staged changes
            </p>
          </div>
        </div>
