 ...
 * rendered output so a template or renderer edit that changes what `CodeSentinel init` /
 * `CodeSentinel qa init` / `CodeSentinel qa fanout-init` write shows up as a reviewable diff.
 */
