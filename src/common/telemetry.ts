...
const TELEMETRY_URL = 'https://telemetry.CodeSentinel.dev/events'

/** Anonymous, opt-out usage telemetry. Disable with CodeSentinel_TELEMETRY=false. */
...
const sendEvent = (
  ...
  const event = {
    ...
    system: {
      ...
      CodeSentinel_version: process.env.npm_package_version ?? 'unknown',
    },
  }
