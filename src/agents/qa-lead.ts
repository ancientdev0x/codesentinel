...
/**
 * CodeSentinel QA lead (depth 0). It explores the repo, catalogs flows, then FANS OUT
...
export default createAgent(async ({ env }) => {
  ...
  // MCP tools are optional (empty unless CodeSentinel_MCP_SERVERS is set); connected here
