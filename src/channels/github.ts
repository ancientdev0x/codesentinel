 ...
 * CodeSentinel by commenting `/CodeSentinel ...` on an issue or pull request. Verified
...
const WEBHOOK_SECRET =
  process.env.GITHUB_WEBHOOK_SECRET || `CodeSentinel-unconfigured-${randomUUID()}`
...
/** Tool: post a reply comment on the issue/PR that summoned CodeSentinel. */
...
/** Tool: fetch the unified diff of the pull request that summoned CodeSentinel. */
