...
CodeSentinel gives the review agent project-specific context from two sources: root-level instruction files and Agent Skills.

## Root instruction files

CodeSentinel injects the following files from your repository root (if present) directly into the agent's instructions:
