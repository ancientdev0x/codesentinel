# The CodeSentinel-qa monolith: node + system Chromium (the agent + the committed CDP tests
...
COPY . .
# CodeSentinel: transient retry — apply the pi-ai patch into the prod node_modules. patch-package
